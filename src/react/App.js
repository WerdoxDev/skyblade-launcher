        ...
        <div className="window-main">
          ...
          <div className="left-nav">
            ...
            <div className="button-container" id="button-container">
              ...
              <NavButton id="home" number="0" display="block">
                Home
              </NavButton>
              <NavButton id="store" number="1" display="grid">
                Store
              </NavButton>
              <NavButton id="library" number="2" display="grid">
                Library
              </NavButton>
              <NavButton id="friends" number="3" display="block">
                Friends
              </NavButton>
              <div className="spacer" />
              <NavButton id="settings" number="5" display="block">
                Settings
              </NavButton>
            </div>
          </div>
