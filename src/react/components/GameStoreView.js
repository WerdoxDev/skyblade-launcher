...
const ProgressBar = props => {
  return (
    <div className="progress-bar" id="progress-bar">
      ...
      <div className="download-status">{`${props.speed} | ${props.downloaded}Mb / ${props.total}Mb (${props.percentage}%)`}</div>
    </div>
  );
};
      ...
      this.setState({
        ...
        speed:
          (arg.speed / 1000).toFixed(2) * 2 >= 1000
            ? (arg.speed / 1000000).toFixed(2) * 2 + "Mb"
            : (arg.speed / 1000).toFixed(2) * 2 + "Kb"
      });
    });
  }
  ...
  handleClick(id) {
    if (id === "download") {
      ipcRenderer?.send(
        ...
        "https://s16.picofile.com/d/8419852626/4f8c509b-8a27-46e2-87ec-b77c1d10ce2d/Build.zip"
      );
            ...
            <div className="main-content">
              ...
              <div className="description-border">
                <div>
                  ...
                  Metus dictum at tempor commodo. Ipsum dolor sit amet
